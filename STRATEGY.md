...
Команда на Kaggle: **Mamarin & Solomenchuk**.
...
Все успешные отправки на публичную часть лидерборда, по возрастанию даты:

| # | Дата (UTC) | Описание | Публичный CER |
|:-:|:--|:--|:--:|
| 1 | 2026-04-12 06:41 | `baseline_quick_full_test_v1` — первая рабочая отправка baseline | 27.122 |
| 2 | 2026-04-12 07:09 | `baseline_quick_full_test_v2_epoch2` — dev 0.1182 | 12.061 |
| 3 | 2026-04-12 07:59 | `baseline_quick_full_test_v3_epoch3_aug` — dev 0.0738 (конец прошлой сессии) | 6.835 |
| 4 | 2026-04-21 09:56 | `aug_v2 epoch 1` — codec/bandwidth/pitch/SpecAugment + балансировка, dev 0.0535 | 5.082 |
| 5 | 2026-04-21 10:24 | `aug_v2_cont epoch 5` — dev 0.0472 | 4.618 |
| 6 | 2026-04-21 10:29 | `aug_v2_cont epoch 6` — dev 0.0455 | 4.440 |
| 7 | 2026-04-21 11:05 | `SWA(epoch 8, 9)` с beam=16, dev 0.0394 | 4.034 |
| 8 | 2026-04-22 02:44 | `scratch + SWA(16, 18, 19, 20) + TTA + beam16`, dev 0.0223 | 2.362 |
| 9 | 2026-04-22 06:07 | `reverb + SWA(23, 25, 26) + TTA + beam16`, dev 0.0152 | 1.507 |
| 10 | 2026-04-22 17:00 | **`ensemble(сид 42 reverb SWA + сид 43 e20) + TTA + beam16`, dev 0.0115 — финал** | **0.946** |

Все чекпоинты отбирались по локальному валидационному CER, а не по значениям лидерборда.
